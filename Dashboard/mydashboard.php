        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <nav id="sidebar" class="col-md-3">
                    ...
                    <ul class="list-group">
                        <li class="list-group-item"><a href="https://googlesite.com/view/hetasvi_harsoda" target="_blank">Google Site</a></li>
                        <li class="list-group-item"><a href="https://www.linkedin.com/in/Hetasvi Harsoda/" target="_blank">LinkedIn</a></li>
      
                        <li class="list-group-item"><a href="https://https://github.com/hetasvi-patel/Web-development-using-PHP" target="_blank">GitHub</a></li>
                    </ul>
                </nav>
                <!-- Main content -->
                <main class="col-md-9">
                    ...
                    <div class="container">
                        ...
                        <div class="dashboard-item">
                            ...
                            <div class="btn-group">
                                <button class="ocean-blue-button gradient-button"><a href="https://github.com/hetasvi-patel/Web-development-using-PHP/tree/main/Task-1" target="_blank">Task 1</a></button>
    <button class="sunset-orange-button gradient-button"><a href="https://github.com/hetasvi-patel/Web-development-using-PHP/tree/main/task2" target="_blank"> Task 2</a></button>
    <button class="spring-green-button gradient-button"><a href="https://github.com/hetasvi-patel/Web-development-using-PHP/tree/main/task-3" target="_blank">Task 3</a></button>
